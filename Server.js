...
//  Auteur : Mr KIRA_TECH
//  Version : 1.0.0
//  Déploiement : Render (avec disque persistant pour auth_info)
//  Toutes les clés API sont optionnelles.
// ============================================================
...
let botOwnerNumber = '';          // numéro du propriétaire actuel (dernier pairing)
let sudoList = [];               // admins supplémentaires
let groupSettings = {};          // configuration par groupe
let chatStates = {};             // anti-spam
...
// ============================================================
//  FONCTIONS D'ENVOI DE MESSAGES WHATSAPP
// ============================================================
...
// ============================================================
//  GESTION DES PARAMÈTRES DE GROUPES (fichier)
// ============================================================
...
commands.unban = async (msg, args, from, sender) => {
    if (!isOwner(sender)) return sendText(from, '❌ Seul le propriétaire.');
    sendText(from, `⚠️ Unban non implémenté.`);
};
